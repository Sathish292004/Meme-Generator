        ...
        <div className="backdrop-blur-md bg-white/10 p-8 rounded-2xl shadow-xl border border-white/20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="flex justify-center md:justify-end space-x-4">
              <a
                href="https://github.com/Sathish292004/Meme-Generator"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/sathishkumar292004/"
                target="_blank"
                rel="noopener noreferrer"
                className="social-icon p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300"
              >
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm">
                <li><a href="https://github.com/Sathish292004" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">Contribute</a></li>
                <li><a href="https://github.com/Sathish292004/Meme-Generator/issues" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">Issues</a></li>
          ...
          <div className="mt-8 pt-6 border-t border-white/20">
            <div className="text-center">
              <p className="text-gray-400 text-xs">
                Built with ❤️ {currentYear} | Made with React, TailwindCSS & GSAP
              </p>
            </div>
          </div>
        </div>
